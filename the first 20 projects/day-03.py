...
*******************************************************************************''')
print("Welcome to the trasure island game")
print("Your mission is to find the treasure")
action1 = input("left or right? ")
if action1 == "left":
    action2 = input("swim or wait? ")
    if action2 == "wait":
        action3 = input("which door do you choose? red, blue or yellow? ")
        if action3 == "yellow":
            print("you win!")
        elif action3 == "red":
            print("you get fired, game over!")
        elif action3 == "blue":
            print("you get fronzed")
        else:
            print("game over!")
    else:
